...
class GameSuccess extends TBX.Scene2D 
{ 
   private _Game:any; 
   private _Runner:any;
   ...
   { 
       ...
       let Title = TBX.SceneObjectUtil.CreateTile("Title", ["Resources/Textures/Complete.png"], new TBX.Vertex(960, 250, 0.3), new TBX.Vertex(750, 120, 1));
       Title.Fixed = true;
       this.Attach(Title);
